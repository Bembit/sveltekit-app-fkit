...
<a target="_blank" href={url} class="mb-2 stack w-full max-w-md text-center bg-base-300 flex justify-center items-center p-4 rounded-lg not-prose no-underline">
